...
The total value of the pool would be equal to \(1,004,931.50 + 1,000,000\) 2,004,931.50 TUSD which is the sum of the value of stablecoins \(1,000,000 TUSD\) and loan tokens \(1,004,931.50 TUSD\). Number of pool tokens in circulation is still equal to 2 Mn, and therefore the price of a tfTUSD token would be equal to \(2,004,931.50 TUSD / 2,000,000\) 1.002465 TUSD.
