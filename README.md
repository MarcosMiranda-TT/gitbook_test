...
* Lenders earn attractive APY on their cryptocurrency by lending TUSD or USDC to TrueFi lending pools, while enjoying full transparency of how their funds are allocated. Lenders may also farm TRU alongside their yields. TrueFi lending pools are controlled by TrueTrading, an affiliate company of TrustToken, Inc.
...
Lenders can lend their stablecoins \(TUSD or USDC\) to the TrueFi lending pools to earn attractive return.

The lending pools may then lend all Lender assets pooled this way to Borrowers based on the predefined strategies of each lending pool.
...
The FAQs will get into the details of the credit prediction market and the exact mechanism for staking TRU in the [Staking](stake/) section and the [Loan approval process](loan-approval-process.md).
