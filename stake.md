...
The cooldown period has been added to prevent any kind of gamification which might be possible by staking for a very short period of time. For example, without a cooldown period Stakers could stake on the protocol to earn the origination fee and then immediately unstake. This might result in some Stakers earning a return which is disproportionate to the amount of risk they are helping mitigate. Staked TRU cannot be unstaked from the protocol during the cooldown period. 
...
Staking TRU on the protocol enables Stakers to earn a portion of the loan origination fees generated by the TrueFi protocol. Currently, Stakers earn 100% of the fees generated by the TrueFi protocol.

The loan origination fees generated by TrueFi will be lent to the TrueFi TUSD Pool in exchange for tfUSDC tokens and stakers will be rewarded with the tfUSDC tokens. The proportion of fees paid to stakers can be changed through protocol governance.  
